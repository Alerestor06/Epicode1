...
if(inizioFine == 'Y'){
    ...
    printf("1)1494\n2)1492\n3)1498\n");
    scanf(" %s", risposta);
    if(strcmp(risposta, "2")==0 || strcmp(risposta, "1492")==0){ //per confrontare due stringhe utilizziamo la funzione string compare della libreria <string.h> perchè c non può usare il == tra stringhe perchè confronteresti gli indirizzi di memoria e non il contenuto
